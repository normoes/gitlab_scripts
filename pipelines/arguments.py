...
def get_cli_arguments():
    ...
    parser = argparse.ArgumentParser(description='Create Pipeline.', epilog="python create_pipeline.py --token $(pass show work/CSS/gitlab/private_token) --url <gitlab_url> --project <gitlab_project_id> --reference <branch_tag_or_other_reference>", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument(
        "--version",
        action="version",
